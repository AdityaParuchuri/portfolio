      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-20">
        ...
        >
          <motion.div
            ...
            className="mb-6 flex justify-center group cursor-pointer"
          >
            <div className="w-[120px] h-[120px] md:w-[160px] md:h-[160px] rounded-full overflow-hidden glass ring-2 ring-[rgba(var(--accent-primary-rgb),0.3)] ring-offset-2 ring-offset-[var(--bg-primary)] shadow-xl transition-all duration-300 group-hover:scale-110 hover-accent-shadow-strong">
              <Image
